...
struct Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics
{
	struct _Script_END2608_eventDBindEventEvent_Parms
	{
		float Ratio;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::NewProp_Ratio = { "Ratio", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_END2608_eventDBindEventEvent_Parms, Ratio), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::NewProp_Ratio,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_END2608, nullptr, "DBindEventEvent__DelegateSignature", Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::_Script_END2608_eventDBindEventEvent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::_Script_END2608_eventDBindEventEvent_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_END2608_DBindEventEvent__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FDBindEventEvent_DelegateWrapper(const FMulticastScriptDelegate& DBindEventEvent, float Ratio)
{
	struct _Script_END2608_eventDBindEventEvent_Parms
	{
		float Ratio;
	};
	_Script_END2608_eventDBindEventEvent_Parms Parms;
	Parms.Ratio=Ratio;
	DBindEventEvent.ProcessMulticastDelegate<UObject>(&Parms);
}
